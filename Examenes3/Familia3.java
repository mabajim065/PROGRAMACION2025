...
public class Familia3 {
	...
	private Persona3[] listaPersonas;
	...
	public Familia3(String id, String nombre, String direccion, boolean esNumerosa, boolean esMonoParental,
			int ingresosMensuales, Persona3[] listaPersonas) {
		super();
		this.id = id;
		this.nombre = nombre;
	 ...
	 */
	public Persona3[] getListaPersonas() {
	 ...
	 */
	public void setListaPersonas(Persona3[] listaPersonas) {
		this.listaPersonas = listaPersonas;
	}
