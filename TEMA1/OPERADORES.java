...
public class OPERADORES {
	...
	public static void main(String[] args) {
		...
		// el operador si se pone a la izquierda, tendra preferencia y sera lo primero
		// que se ejecute
		// si se pone a la derecha de la variable se ejecutara despues del resto de
		// operadires o funciones
