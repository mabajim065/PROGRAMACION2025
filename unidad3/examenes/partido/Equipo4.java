package unidad3.examenes.partido;
	...
	public class Equipo4 implements Comparable<Equipo4> {
		 ...
		 */
		public Jugador4[] getListaJugadores() {
		 ...
		 */
		public void setListaJugadores(Jugador4[] listaJugadores) {
		...
		public Equipo4() {
			...
			// posiciones
			this.listaJugadores = new Jugador4[20];
		...
		public Equipo4(String id, String nombre, int puntos, int numGoles, int numGolesRec, int presupuesto,
				String estadio) {
			super();
			this.numE++;
			this.id = id;
		...
		@Override
		public int compareTo(Equipo4 otro) {
