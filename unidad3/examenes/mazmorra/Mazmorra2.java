package unidad3.examenes.mazmorra;
...
public class Mazmorra2 {
		...
		public Trampa2 listaTra[];
		public Monstruo2 listaMon[];
		...
		public Mazmorra2(String nombre, int tamanio, String clima, int nivel, Trampa2[] listaTra, Monstruo2[] listaMon) {
			super();
			this.nombre = nombre;
		...
		public Monstruo2 enemigoFinal() {
			...
			if (listaMon[posMon].getDebilidad() != Monstruo2.COSQUILLAS && (listaMon[posMon].getTipo() == Monstruo2.DRAGONES
